...
public class SkateboardController : MonoBehaviour
{
    ...
    private void ProcessInputs()
    {
        ...
        m_Right = Input.GetAxis("Horizontal");
    ...
    private void ProcessForce()
    {
        if (!m_onSurface)
            return;
        Vector3 movement = new Vector3(m_Right, 0f, m_Forward).normalized;
        m_rigidbody.AddForce(m_skateboard.forward * m_FwdForce + movement);
    }
